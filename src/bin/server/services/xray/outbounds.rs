use crate::{
    http::models::xray_config::XrayOutboundClientConfig, services::xray::file::XrayFileCore,
};
...
pub fn update_outbounds(config_ids: &Vec<i32>) -> Result<Vec<XrayOutboundClientConfig>, Error> {
    ...
    // let configs = ConfigsStorageService::new()
    //     .get_configs_by_ids(config_ids.as_slice())
    //     .unwrap();
